...
const ALBUMS = [
  {
    ...
    cover: ALBUM_COVER,
    tracks: [
      { num: 1, title: 'Трек 1', duration: '—' },
      { num: 2, title: 'Трек 2', duration: '—' },
      { num: 3, title: 'Трек 3', duration: '—' },
      { num: 4, title: 'Трек 4', duration: '—' },
      { num: 5, title: 'Трек 5', duration: '—' },
      { num: 6, title: 'Трек 6', duration: '—' },
      { num: 7, title: 'Трек 7', duration: '—' },
      { num: 8, title: 'Трек 8', duration: '—' },
      { num: 9, title: 'Трек 9', duration: '—' },
      { num: 10, title: 'Трек 10', duration: '—' },
      { num: 11, title: 'Трек 11', duration: '—' },
    ],
  },
];
